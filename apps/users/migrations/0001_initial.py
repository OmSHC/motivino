    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.IntegerField(blank=True, help_text='Student grade (1-12)', null=True)),
                ('school', models.CharField(blank=True, help_text='School name', max_length=255, null=True)),
